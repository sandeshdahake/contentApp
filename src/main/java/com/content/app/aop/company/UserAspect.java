package com.content.app.aop.company;

import com.content.app.security.SecurityUtils;
...
import com.content.app.domain.CompanyParameter;
...
private final Logger log = LoggerFactory.getLogger(UserAspect.class);
     ...
     */
    @Before(value = "execution(* com.content.app.service.UserService.createUser(..)) && args(userDTO, ..)")
     ...
     */
    @Before(value = "execution(*  com.content.app.service.UserService.updateUser(..)) && args(userDTO, ..)")
     ...
     * Adds tenant information to DTO.
     */
    @Before(value = "execution(* com.content.app.repository.UserRepository.save(..)) && args(user, ..)")
     ...
     */
    @Before(value = "execution(* com.content.app.service.UserService.getUserWithAuthoritiesByLogin(..)) && args(login, ..)")
     ...
     * Adds filtering to prevent display of information from another tenant
     */
    @Before(value = "execution(* com.content.app.service.UserService.getUserWithAuthorities(..)) && args(id, ..)")
