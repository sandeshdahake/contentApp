    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="contentApp.company.home.createOrEditLabel">
              <Translate contentKey="contentApp.company.home.createOrEditLabel">Create or edit a Company</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : companyEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="nameLabel" for="company-name">
                    <Translate contentKey="contentApp.company.name">Name</Translate>
                  </Label>
                  <AvField
                    id="company-name"
                    type="text"
